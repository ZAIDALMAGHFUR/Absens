...
function _render(props, slot = {}, tag, name) {
  ...
  if (Component === import_react13.Fragment) {
    if (Object.keys(compact(rest)).length > 0) {
      ...
      let newClassName = classNames((_a2 = resolvedChildren.props) == null ? void 0 : _a2.className, rest.className);
...
var Options = forwardRefWithAs(function Options2(props, ref) {
  ...
  useIsoMorphicEffect(() => {
    var _a2;
    data.optionsPropsRef.current.static = (_a2 = props.static) != null ? _a2 : false;
  ...
  let labelledby = useComputed(() => {
    var _a2, _b;
    return (_b = data.labelId) != null ? _b : (_a2 = data.buttonRef.current) == null ? void 0 : _a2.id;
...
var DialogRoot = forwardRefWithAs(function Dialog(props, ref) {
  ...
  let resolveContainers = useEvent(() => {
    var _a2, _b;
    let rootContainers = Array.from((_a2 = ownerDocument == null ? void 0 : ownerDocument.querySelectorAll("html > *, body > *, [data-headlessui-portal]")) != null ? _a2 : []).filter((container) => {
...
var Button3 = forwardRefWithAs(function Button4(props, ref) {
  ...
  let slot = (0, import_react30.useMemo)(() => ({ open: state.disclosureState === 0 /* Open */ }), [state]);
...
var Panel3 = forwardRefWithAs(function Panel4(props, ref) {
  ...
  let slot = (0, import_react30.useMemo)(() => ({ open: state.disclosureState === 0 /* Open */, close }), [state, close]);
  let ourProps = {
    ref: panelRef,
    id
  };
...
var ListboxRoot = forwardRefWithAs(function Listbox(props, ref) {
  ...
  let [value = multiple ? [] : void 0, theirOnChange] = useControllable(controlledValue, controlledOnChange, defaultValue);
  let [state, dispatch] = (0, import_react31.useReducer)(stateReducer4, {
...
var Button7 = forwardRefWithAs(function Button8(props, ref) {
  ...
  let slot = (0, import_react32.useMemo)(() => ({ open: state.menuState === 0 /* Open */ }), [state]);
  let ourProps = {
    ref: buttonRef,
    id,
...
var PopoverRoot = forwardRefWithAs(function Popover(props, ref) {
  ...
  let buttons = (0, import_react33.useRef)([]);
...
var Button9 = forwardRefWithAs(function Button10(props, ref) {
  ...
  let [uniqueIdentifier] = (0, import_react33.useState)(() => Symbol());
...
var Panel5 = forwardRefWithAs(function Panel6(props, ref) {
  ...
  let slot = (0, import_react33.useMemo)(() => ({ open: state.popoverState === 0 /* Open */, close }), [state, close]);
  let ourProps = {
    ref: panelRef,
    id,
    onKeyDown: handleKeyDown,
...
var RadioGroupRoot = forwardRefWithAs(function RadioGroup(props, ref) {
  ...
  let [state, dispatch] = (0, import_react36.useReducer)(stateReducer7, { options: [] });
  ...
  let radioGroupData = (0, import_react36.useMemo)(() => ({ value, firstOption, containsCheckedOption, disabled, compare, ...state }), [value, firstOption, containsCheckedOption, disabled, compare, state]);
...
var reducers8 = {
  ...
  [1 /* RegisterTab */](state, action) {
    ...
    let selectedIndex = (_a2 = adjustedTabs.indexOf(activeTab)) != null ? _a2 : state.selectedIndex;
    if (selectedIndex === -1)
      selectedIndex = state.selectedIndex;
...
var Tabs = forwardRefWithAs(function Tabs2(props, ref) {
  ...
  let [state, dispatch] = (0, import_react39.useReducer)(stateReducer8, {
    selectedIndex: selectedIndex != null ? selectedIndex : defaultIndex,
    tabs: [],
    panels: []
  });
  let slot = (0, import_react39.useMemo)(() => ({ selectedIndex: state.selectedIndex }), [state.selectedIndex]);
  let onChangeRef = useLatestValue(onChange || (() => {
  }));
  let stableTabsRef = useLatestValue(state.tabs);
  let tabsData = (0, import_react39.useMemo)(() => ({ orientation, activation, ...state }), [orientation, activation, state]);
  ...
  let SSRCounter = (0, import_react39.useRef)({ tabs: 0, panels: 0 });
...
var TransitionChild = forwardRefWithAs(function TransitionChild2(props, ref) {
  ...
  let [state, setState] = (0, import_react40.useState)(show ? "visible" /* Visible */ : "hidden" /* Hidden */);
